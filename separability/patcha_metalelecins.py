from FEMfuns import *
import parameters_metalelecins as params
...
tic = time()
FEMsim.main(solver_method='cg', preconditioner='ilu', lagrange_multiplier=True)
...
np.save('results/patcha_metalelecins_M1S1_LFM.npy',elvals_disc)
np.savetxt('results/patcha_metalelecins_M1S1_LFM.txt',np.concatenate((elec_coords,elvals_disc),axis=1),delimiter=",")
