from FEMfuns import *
import parameters_metalelec as params
...
np.save('results/patcha_metalelec_M1S1_LFM.npy',elvals_disc)
np.savetxt('results/patcha_metalelec_M1S1_LFM.txt',np.concatenate((elec_coords,elvals_disc),axis=1),delimiter=",")
