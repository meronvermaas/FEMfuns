...
np.save('results/patcha_pointelec_M1S1_LFM.npy',elvals_point)
np.savetxt('results/patcha_pointelec_M1S1_LFM.txt',np.concatenate((elec_coords,elvals_point),axis=1),delimiter=",")
